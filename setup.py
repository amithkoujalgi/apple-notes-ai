...
setup(
    name='notes-ai',
    version=get_version(),
    description='An interactive commandline interface that brings intelligence to your notes.',
    ...
    project_urls={
        'Repository': 'https://github.com/amithkoujalgi/apple-notes-ai'
    },
